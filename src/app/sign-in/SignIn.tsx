...
const Signin: React.FC = () => {
  ...
  const login = async (event?: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      } else if (user.role === 'ewaste_center') {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 md:p-8">
      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        {/* Left Side - Branding */}
        <div className="md:w-5/12 bg-gradient-to-br from-emerald-600 to-emerald-800 p-8 md:p-12 flex flex-col justify-between relative overflow-hidden">
          {/* Decorative circles */}
          ...
          <div className="relative z-10">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">EWAYGO</h1>
            <p className="text-emerald-100 text-lg">E-Waste Management System</p>
          </div>
          
          <div className="relative z-10 my-8">
            <p className="text-white/90 text-lg leading-relaxed">
              "Join us in our mission to create a sustainable future by properly disposing electronic waste."
            </p>
          </div>
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 text-white/80">
              ...
              <span className="text-sm">Eco-friendly E-waste Solutions</span>
            </div>
          </div>
        </div>
        ...
        <div className="md:w-7/12 p-8 md:p-12 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            ...
            <form className="space-y-5" onSubmit={login}>
              ...
              {/* Submit Button */}
              <button
                className={`w-full py-3 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-xl transition-all transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 ${isLoading ? 'opacity-80 cursor-not-allowed' : ''}`}
                type="submit"
                disabled={isLoading}
              >
                {isLoading ? (
