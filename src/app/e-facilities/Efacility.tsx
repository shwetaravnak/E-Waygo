...
const FacilityMap: React.FC = () => {
  ...
  useEffect(() => {
    if (clientLocation) {
      ...
      // Add Geolocate control to allow users to snap to precise current location
  ...
  return (
    <>
      <Head>
        <title>E-Waygo - Find Nearby E-Waste Recycling Facilities</title>
